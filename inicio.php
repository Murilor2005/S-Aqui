...
<body>
    ...
    <br>
    <br>
    <h1 class="tit-page">Minhas Publicações</h1>
    <br>
    <br>
    <main>
        <?php
        ...
        $sql = "SELECT * FROM publicacao WHERE autor='$nomeus' ORDER BY datee DESC ";
        ...
        while ($linha = mysqli_fetch_assoc($resultado)) {
            ...
            echo "<label><b><i>Categoria: <u> " . $linha['filtro'] . "</u></i></b><br><br></label>";
