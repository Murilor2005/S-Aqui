...
<body>
    ...
    <br>
    <br>
    <h1 class="tit-page">Publicações classificadas como 'Noticias do mundo da música!'</h1>
    <br>
    <br>
    <main>
        <?php
        ...
        $sql = "SELECT * FROM publicacao WHERE visu='Pública' AND filtro='Noticias do mundo da música' ORDER BY datee DESC ";
