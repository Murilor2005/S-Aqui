...
<body>
    ...
    <br>
    <br>
    <h1 class="tit-page">Publicações classificadas como 'Como Aprender?'</h1>
    <br>
    <br>
    <main>
        <?php
        ...
        $sql = "SELECT * FROM publicacao WHERE visu='Pública' AND filtro='Como Aprender?' ORDER BY datee DESC ";
