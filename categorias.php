...
<body>
    <div id="login">
        ...
        <form method="POST" action="loginins.php">
            ...
            <label for="user"><a class="opc" href="catanot.php">Anotação!</a> </label><br>

            <label for="user"><a class="opc" href="catnoti.php">Noticias do mundo da música!</a> </label><br>

            <div id="bloco">
                <div id="cadastro">
                    <br>
                    <p>Clique abaixo para voltar para as Minhas Anotações!</p>
                    <a href="inicio.php" id="forgot-pass">Clique aqui para voltar a página de Minhas Anotações!</a>
                </div>
            </div>
            <br>
